...
#
# Created: Fri Jun 22 09:53:16 2012
...
class Ui_Find(object):
    def setupUi(self, Find):
        ...
        self.gridLayout.addWidget(self.instruction, 4, 0, 1, 1)
        self.hitlist = QtGui.QTreeWidget(Find)
        self.hitlist.setObjectName("hitlist")
        self.gridLayout.addWidget(self.hitlist, 6, 0, 1, 1)
    ...
    def retranslateUi(self, Find):
        ...
        self.status.setText(QtGui.QApplication.translate("Find", "Result", None, QtGui.QApplication.UnicodeUTF8))
